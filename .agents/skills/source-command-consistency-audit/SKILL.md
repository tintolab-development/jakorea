---
name: "source-command-consistency-audit"
description: "Migrated source command `consistency-audit`"
---

# source-command-consistency-audit

Use this skill when the user asks to run the migrated source command `consistency-audit`.
