...
import {
  ...
  FindEmailIdentityCallbackPage,
  FindEmailNotFoundPage,
  FindEmailPage,
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/auth/find-email/not-found', element: <FindEmailNotFoundPage /> },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/auth/find-email/identity/callback',
        element: <FindEmailIdentityCallbackPage />,
      },
      {
        path: '/auth/find-email/identity/mock',
