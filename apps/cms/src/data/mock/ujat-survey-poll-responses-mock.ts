...
/** survey-default 양식 기준 10명 목응답 (Q2 객관식 + Q3~Q8 점수선택형 + Q9~Q11 주관식 + Q12 별점) */
export const UJAT_SURVEY_POLL_RESPONSES_MOCK: UjatSurveyPollRawResponse[] = [
  {
    ...
    answers: {
      ...
      [P.score4]: 'scale-type-item-3',
      [P.score5]: 'scale-type-item-3',
      [P.score6]: 'scale-type-item-3',
      [P.score7]: 'scale-type-item-3',
      [P.subjective]: '다음에는 더 긴 버전을 기대하고 있어요!',
      [P.subjective2]: '워크숍 진행 속도가 적당했습니다.',
      [P.subjective3]: '심화 교육 콘텐츠가 필요합니다.',
      [P.star]: '3',
    },
  },
  {
    ...
    answers: {
      ...
      [P.score3]: 'scale-type-item-2',
      [P.score4]: 'scale-type-item-2',
      [P.score5]: 'scale-type-item-2',
      [P.score6]: 'scale-type-item-2',
      [P.score7]: 'scale-type-item-2',
      [P.subjective]: '내용이 흥미로웠고, 배운 점이 많았습니다.',
      [P.subjective2]: '강의 자료가 이해하기 쉬웠어요.',
      [P.subjective3]: '기초 다지기 콘텐츠가 필요합니다.',
      [P.star]: '2',
    },
  },
  {
    ...
    answers: {
      [P.score]: 'multiple-choice-item-3',
      [P.score2]: 'scale-type-item-2',
      [P.score3]: 'scale-type-item-2',
      [P.score4]: 'scale-type-item-2',
      [P.score5]: 'scale-type-item-2',
      ...
      [P.subjective3]: '질의응답형 콘텐츠가 필요합니다.',
      [P.star]: '2',
    },
  },
  {
  ...
  },
  {
    ...
    answers: {
      [P.score]: 'multiple-choice-item-4',
      [P.score2]: 'scale-type-item-3',
      [P.score3]: 'scale-type-item-3',
      [P.score4]: 'scale-type-item-3',
      [P.score5]: 'scale-type-item-3',
      ...
      [P.subjective3]: '추천 프로그램 안내가 필요합니다.',
      [P.star]: '3',
    },
  },
  {
    ...
    answers: {
      ...
      [P.subjective3]: '강사 가이드 콘텐츠가 필요합니다.',
      [P.star]: '4',
    },
  },
  {
    ...
    answers: {
      ...
      [P.subjective3]: '일정 안내 콘텐츠가 필요합니다.',
      [P.star]: '4',
    },
  },
  {
  ...
  },
  {
    ...
    answers: {
      ...
      [P.subjective3]: '진로 탐색 콘텐츠가 필요합니다.',
      [P.star]: '5',
    },
  },
  {
