...
type TemplateSelectModalProps = {
  ...
  getTemplateUnusableMessage?: (template: SmsTemplateItem) => string | null
  zIndex?: number
}

function matchesTemplateName(template: SmsTemplateItem, keyword: string): boolean {
...
export function TemplateSelectModal({
  ...
  const columns: ColumnsType<SmsTemplateItem> = [
    {
      title: '템플릿명',
      dataIndex: 'name',
      key: 'name',
