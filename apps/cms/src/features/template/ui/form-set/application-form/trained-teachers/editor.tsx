...
/** 교육받은 교사 프로그램 참여자 신청 폼 전용 편집 UI */
export function TrainedTeachersProgramApplicationEditorLeftColumn({
  vm,
}: {
...
export function TrainedTeachersProgramApplicationEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
