...
export function UjatProgramApplicationFormVolunteerEditorLeftColumn({
  ...
  return (
    <div className="ujat-program-application-form-volunteer ujat-program-application-form-volunteer--editor-left">
      <FormEditorLeftPanel
...
export function UjatProgramApplicationFormVolunteerEditorRightColumn({
  ...
  return (
    <div className="ujat-program-application-form-volunteer ujat-program-application-form-volunteer--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
