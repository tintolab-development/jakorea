...
/** UJAT 프로그램 학교 신청 폼 전용 편집 UI */
export function UjatProgramApplicationFormInstitutionEditorLeftColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="ujat-program-application-form-institution ujat-program-application-form-institution--editor-left">
      <FormEditorLeftPanel
...
export function UjatProgramApplicationFormInstitutionEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="ujat-program-application-form-institution ujat-program-application-form-institution--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
