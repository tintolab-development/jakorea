...
export function ProgramParticipantApplicationEditorLeftColumn({
  vm,
}: {
  ...
  return (
    <FormEditorLeftPanel
      ...
      paragraphBodyOptions={{
        ...
        hiddenParagraphIds: vm.individualApplicationHiddenParagraphIds,
      }}
...
export function ProgramParticipantApplicationEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
