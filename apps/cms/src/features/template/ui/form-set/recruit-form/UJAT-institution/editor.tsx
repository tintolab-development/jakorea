...
export function UjatRecruitFormInstitutionEditorLeftColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="ujat-recruit-form-institution ujat-recruit-form-institution--editor-left">
      <FormEditorLeftPanel
        ...
        paragraphBodyOptions={{
          ...
          ujatRecruitFormInstitution: true,
        }}
...
export function UjatRecruitFormInstitutionEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="ujat-recruit-form-institution ujat-recruit-form-institution--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
