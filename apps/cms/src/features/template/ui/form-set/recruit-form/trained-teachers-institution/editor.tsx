...
export function TrainedTeachersRecruitFormInstitutionEditorLeftColumn({
  vm,
}: {
  ...
  return (
    <FormEditorLeftPanel
      ...
      paragraphBodyOptions={{
        ...
        trainedTeachersRecruitFormInstitution: true,
      }}
...
export function TrainedTeachersRecruitFormInstitutionEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
