...
/** 프로그램 봉사자 모집 폼 전용 편집 UI */
export function RecruitFormVolunteerEditorLeftColumn({
  vm,
}: {
...
export function RecruitFormVolunteerEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="recruit-form-volunteer recruit-form-volunteer--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
