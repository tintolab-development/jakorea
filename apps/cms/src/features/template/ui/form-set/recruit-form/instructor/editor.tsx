...
/** 프로그램 강사 모집 폼 전용 편집 UI */
export function RecruitFormInstructorEditorLeftColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="recruit-form-instructor recruit-form-instructor--editor-left">
      <FormEditorLeftPanel
...
export function RecruitFormInstructorEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
