...
/** 1사1교_참여 기관 모집 폼 전용 편집 UI */
export function EconomyRecruitFormInstitutionEditorLeftColumn({
  vm,
}: {
  ...
  return (
    <FormEditorLeftPanel
      ...
      paragraphBodyOptions={{
        ...
        economyRecruitFormInstitution: true,
      }}
...
export function EconomyRecruitFormInstitutionEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
