...
function ThumbnailPlaceholderSvg() {
  return (
    <svg
      ...
      aria-hidden
    >
      <g clipPath="url(#recruitInstructorThumbClip)">
        <rect width="86" height="86" rx="8" fill="white" />
        <mask
          id="recruitInstructorThumbMask"
        ...
        <g mask="url(#recruitInstructorThumbMask)">
          <path
      ...
      <defs>
        <clipPath id="recruitInstructorThumbClip">
          <rect width="86" height="86" rx="8" fill="white" />
        </clipPath>
      </defs>
    </svg>
...
export function RecruitFormInstructorDetailInfoParagraph() {
  ...
  const { editorHostRef } = useNoticeWysiwygEditor(true, '', 'recruit-form-instructor-extra-body', {
