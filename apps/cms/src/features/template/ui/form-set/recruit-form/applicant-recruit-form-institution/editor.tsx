...
export function ApplicantRecruitFormInstitutionEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="applicant-recruit-form-institution applicant-recruit-form-institution--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
