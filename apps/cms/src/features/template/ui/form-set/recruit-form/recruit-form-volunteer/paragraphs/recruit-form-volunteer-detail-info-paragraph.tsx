...
function ThumbnailPlaceholderSvg() {
  return (
    <svg
      ...
      aria-hidden
    >
      <g clipPath="url(#recruitVolunteerThumbClip)">
        <rect width="86" height="86" rx="8" fill="white" />
        <mask
          id="recruitVolunteerThumbMask"
        ...
        <g mask="url(#recruitVolunteerThumbMask)">
          <path
      ...
      <defs>
        <clipPath id="recruitVolunteerThumbClip">
          <rect width="86" height="86" rx="8" fill="white" />
        </clipPath>
      </defs>
    </svg>
...
export function RecruitFormVolunteerDetailInfoParagraph() {
  ...
  const { editorHostRef } = useNoticeWysiwygEditor(true, '', 'recruit-form-volunteer-extra-body', {
    ...
    <DetailInfoForm title="상세 정보" hideHeader mode="edit">
      ...
      <DetailInfoForm.Row type="single">
        <DetailInfoForm.Field
          label="프로그램명"
          fullRow
          edit={<CmsInput inputSize="medium" width="100%" placeholder="프로그램명을 작성하세요" />}
          view="-"
        />
      </DetailInfoForm.Row>
      ...
      <DetailInfoForm.Row type="single">
        <DetailInfoForm.Field
          label="모집 안내"
          fullRow
          edit={<CmsInput inputSize="medium" width="100%" placeholder="모집 안내를 작성하세요" />}
          view="-"
        />
      </DetailInfoForm.Row>
      ...
      <DetailInfoForm.Row type="single">
        <DetailInfoForm.Field
          label="지원 방법"
          fullRow
          edit={<CmsInput inputSize="medium" width="100%" placeholder="지원 방법을 작성하세요" />}
          view="-"
        />
      </DetailInfoForm.Row>
