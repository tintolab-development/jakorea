...
export function ApplicantRecruitFormIndividualEditorLeftColumn({
  ...
  return (
    <div className="applicant-recruit-form-individual applicant-recruit-form-individual--editor-left">
      <FormEditorLeftPanel
        ...
        paragraphBodyOptions={{
          ...
          applicantRecruitFormIndividual: true,
        }}
...
export function ApplicantRecruitFormIndividualEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="applicant-recruit-form-individual applicant-recruit-form-individual--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
