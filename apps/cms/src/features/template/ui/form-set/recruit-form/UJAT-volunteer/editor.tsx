...
/** UJAT 프로그램 봉사자 모집 폼 전용 편집 UI */
export function UjatRecruitFormVolunteerEditorLeftColumn({
  vm,
}: {
    ...
    <div className="ujat-recruit-form-volunteer ujat-recruit-form-volunteer--editor-left">
      <FormEditorLeftPanel
        ...
        paragraphBodyOptions={{
          ...
          programApplicationFormVolunteer: { enabled: true, isTemplateAuthoringMode: true },
        }}
...
export function UjatRecruitFormVolunteerEditorRightColumn({
  vm,
}: {
  vm: ProgramParticipantApplicationEditorViewModel
}) {
  return (
    <div className="ujat-recruit-form-volunteer ujat-recruit-form-volunteer--editor-right">
      <FormEditorFieldNav
        sectionTitle="커스텀 필드"
