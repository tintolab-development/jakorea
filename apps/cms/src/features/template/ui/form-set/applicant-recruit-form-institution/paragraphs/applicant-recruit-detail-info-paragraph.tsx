...
function ThumbnailPlaceholderSvg() {
  return (
    <svg
      ...
      aria-hidden
    >
      <g clipPath="url(#applicantRecruitThumbClip)">
        <rect width="86" height="86" rx="8" fill="white" />
        <mask
          id="applicantRecruitThumbMask"
        ...
        <g mask="url(#applicantRecruitThumbMask)">
          <path
      ...
      <defs>
        <clipPath id="applicantRecruitThumbClip">
          <rect width="86" height="86" rx="8" fill="white" />
        </clipPath>
      </defs>
    </svg>
