...
/** 단일항목 에디터 — 항목 행 우측 원형 X (주관식·객관식 등 공통) */
export function ItemDeleteButton({ className, 'aria-label': ariaLabel, onClick }: ItemDeleteButtonProps) {
  const reactId = useId()
  const maskId = `item-delete-mask-${reactId.replace(/:/g, '')}`
