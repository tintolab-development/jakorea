...
export function ProgramDetailFullPageModal({
  ...
  const { program: detailProgram, loading, sponsorName, updateProgram } =
  ...
  const {
    triggerSave: infoTriggerSave,
    resetToProgram: infoResetToProgram,
  ...
  const isEditModeParticipants = activeTab === 'participants' && editTab === 'participants' && !!displayProgram
  ...
  const isEditModeInstructors = activeTab === 'instructors' && editTab === 'instructors' && !!displayProgram
  ...
  const isEditModeVolunteers = activeTab === 'volunteers' && editTab === 'volunteers' && !!displayProgram
                ...
                {activeTab === 'info' ? (
                  ...
                  <>
                    ...
                    <AppButton
                      ...
                      size="large"
                      onClick={
                        isEditModeParticipants ? handleParticipantsSave : handleInfoEdit
                      }
                    >
                  ...
                  <>
                    ...
                    <AppButton
                      ...
                      size="large"
                      onClick={
                        isEditModeVolunteers ? handleVolunteersSave : handleInfoEdit
                      }
                    >
                  ...
                  <>
                    ...
                    <AppButton
                      ...
                      size="large"
                      onClick={
                        isEditModeInstructors ? handleInstructorsSave : handleInfoEdit
                      }
                    >
                    ...
                    <div className="program-detail-fullpage-modal__info-tab-block">
                      <DetailInfoSection
                        ...
                        onRegisterGetAdditionalContentHtml={
                          registerParticipantsAdditionalHtml
                        }
                        showThumbnail
                      />
                    </div>
