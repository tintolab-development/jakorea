/**
 * 봉사자 정보 탭 전용 상세 정보 섹션
 * - 썸네일 이미지, 프로그램 설명, 모집 안내, 지원 방법, 추가 내용, 기타사항, 첨부 파일
 * - 수정 모드: Controller + Toast UI Editor(추가 내용) + FileSelectField 활성화
 * - 일반 모드: 정적 텍스트·이미지, 파일 선택 버튼 비노출
 * - program-detail-info-tab 스타일 및 DetailInfoSection 패턴 재사용
 */
