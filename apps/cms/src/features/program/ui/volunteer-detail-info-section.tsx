/**
 * 봉사자 정보 탭 전용 상세 정보 섹션 (읽기 전용)
 * - 썸네일 이미지, 프로그램 설명, 모집 안내, 지원 방법, 추가 내용, 기타사항, 첨부 파일
 * - 상단 안내: "공란인 경우, 상세 페이지에서 항목 미노출 됩니다."
 * - program-detail-info-tab 스타일 및 InstructorDetailInfoSection 셀 구조 재사용
 */
...
export function VolunteerDetailInfoSection({ program }: VolunteerDetailInfoSectionProps) {
