...
function TypeSettingsScheduleDetailRow({
  ...
  commonDetailEdit,
  commonDetailView,
  perScheduleHint = typeSettingsPerScheduleHint('curriculum'),
}: {
  label: string
  scheduleDetailName:
...
function TypeSettingsSection({
  ...
  const schedulePerScheduleHint = typeSettingsPerScheduleHint(
    isScheduleStructure ? 'schedule' : 'curriculum'
  )
...
function ScheduleSettingsEditFields({
  ...
  }, [autoFillFromScheduleGroupTimes, form])
            ...
            <div className="program-registration-paragraph__schedule-inline">
              <Controller
                ...
                render={({ field }) => (
                  <CmsRadioGroup
                    size="large"
                    value={autoFillFromScheduleGroupTimes ? 'date' : (field.value ?? 'date')}
                    onChange={e => {
