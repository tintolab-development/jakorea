...
function PreviewPagePrevIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden>
      <mask
        id="lecture-report-preview-page-nav-prev-mask"
      ...
      <g mask="url(#lecture-report-preview-page-nav-prev-mask)">
        <path
...
function PreviewPageNextIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden>
      <mask
        id="lecture-report-preview-page-nav-next-mask"
        style={{ maskType: 'alpha' }}
        maskUnits="userSpaceOnUse"
        x="0"
        y="0"
      ...
      <g mask="url(#lecture-report-preview-page-nav-next-mask)">
        <path
...
export function LectureReportIssuancePreviewModal({
  ...
  const handleDownloadPdf = useCallback(async () => {
    ...
    try {
      ...
      handleError(e, { context: 'lectureReportIssuancePreviewModal.downloadPdf' })
          ...
          <div className="full-page-modal__body">
            <div className="full-page-modal__body-header">
              <p className="full-page-modal__description lecture-report-issuance-preview-modal__description">
                제출된 {LECTURE_REPORT_DOCUMENT_TITLE} 미리보기 화면입니다.
              </p>
              {actionButtons}
            </div>
            ...
            <div className="lecture-report-issuance-preview-modal__workspace">
              <div className="lecture-report-issuance-preview-modal__page">
                <A4DocumentPageLayout title={surveyTitle} pageIndex={safePageIndex} pdfCapture>
