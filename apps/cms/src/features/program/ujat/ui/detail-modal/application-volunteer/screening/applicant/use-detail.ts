...
} from '../doc-screening/document-actions'
import {
...
export type ApplicantDetailMetaChangeHandler = (
  meta: ApplicantDetailMeta | null
) => void
export type UseApplicantDetailParams = {
  programId: string
