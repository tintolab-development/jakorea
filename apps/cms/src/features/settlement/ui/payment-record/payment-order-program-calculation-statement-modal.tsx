/**
 * 산출 내역서 모달 — 프로그램형 기본정보 (프로그램별 정산 목록에서 연 때)
 */
...
export function PaymentOrderProgramCalculationStatementModal(
  props: PaymentOrderProgramCalculationStatementModalProps
) {
  return (
    <PaymentOrderCalculationStatementModalImpl
      {...props}
      entryKind="program"
      entryClassName="payment-order-calc-statement-modal--entry-program"
    />
  )
}
