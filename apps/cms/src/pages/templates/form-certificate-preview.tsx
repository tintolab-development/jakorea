...
import { CERTIFICATE_SERIAL_PLACEHOLDER } from '@/features/program/shared/lib/certificate-serial'
...
export interface FormCertificatePreviewProps {
  ...
  /**
   * 좌측 상단 고유번호. 양식 관리 미리보기는 플레이스홀더,
   * 실발급은 진입 시 백엔드가 준 `{YY}-JA-{00000}` 를 넣는다.
   */
  serialNumber?: string
}
