 ...
 */
import type { AdminCommentMutationResponse } from './adminCommentMutationResponse';
 ...
 */
export interface ApiResponseAdminCommentMutationResponse {
  /** 요청 처리 성공 여부 */
  success?: boolean;
  /**
     ...
     * @nullable
     */
  data?: AdminCommentMutationResponse;
  /**
