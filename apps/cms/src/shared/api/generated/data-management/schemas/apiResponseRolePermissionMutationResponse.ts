...
import type { RolePermissionMutationResponse } from './rolePermissionMutationResponse';

/**
 * 공통 API 응답 래퍼. 오류 응답에서는 success=false, data=null, message는 기존 호환용 CODE: message 형식을 유지하고, error에는 프론트 분기용 구조화 오류 정보를 담습니다.
 */
export interface ApiResponseRolePermissionMutationResponse {
  /** 요청 처리 성공 여부 */
  success?: boolean;
  /**
     ...
     * @nullable
     */
  data?: RolePermissionMutationResponse;
  /**
