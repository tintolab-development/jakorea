 ...
 */
import type { EmailAttachmentMutationResponse } from './emailAttachmentMutationResponse';
import type { ErrorDetail } from './errorDetail';

/**
 * 공통 API 응답 래퍼. 오류 응답에서는 success=false, data=null, message에는 사용자 표시용 한국어 문구를 담고, error에는 프론트 분기용 구조화 오류 정보를 담습니다.
 */
export interface ApiResponseEmailAttachmentMutationResponse {
  /** 요청 처리 성공 여부 */
  success?: boolean;
  /**
     ...
     * @nullable
     */
  data?: EmailAttachmentMutationResponse;
  /**
