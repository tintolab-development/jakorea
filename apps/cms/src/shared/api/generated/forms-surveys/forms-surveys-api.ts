...
/**
 * ### 이 API가 하는 일
 * - POST /api/me/programs/{programId}/form-bindings/{bindingId}/responses
 * - API 분류: 피그마/프론트 화면에서 사용하는 화면 API
 * - 사용하는 화면: 폼/템플릿/설문 (`SCR_FORM`)
 * - 프론트 담당 영역: forms-surveys (`forms-surveys`)
 * - 호출 방식: `POST /api/me/programs/{programId}/form-bindings/{bindingId}/responses`
 *
 * ### 화면/프론트 사용 기준
 ...
 * - 날짜, 금액, 상태 배지는 백엔드 원본 값과 화면 정의서의 라벨 매핑을 기준으로 표시합니다.
 * - 검토 메모: Auto-synced from implemented controller route
 * @summary POST /api/me/programs/{programId}/form-bindings/{bindingId}/responses
 */
const submitBinding = (
    programId: number,
    bindingId: number,
 ...
 options?: SecondParameter<typeof customInstance<FormRuntimeResponse>>,) => {
      ...
      {url: `/api/me/programs/${programId}/form-bindings/${bindingId}/responses`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
 ...
 * - 사용하는 화면: 폼/템플릿/설문 (`SCR_FORM`)
 * - 프론트 담당 영역: forms-surveys (`forms-surveys`)
 * - 호출 방식: `GET /api/me/programs/{programId}/form-bindings/{bindingId}/render`
 *
 * ### 화면/프론트 사용 기준
 * - 요청값 출처: 프로그램 상세 선택값, 템플릿 유형, 일정형/커리큘럼형 대상 구간, 사용자 참여 context
...
const renderBinding = (
 ...
 options?: SecondParameter<typeof customInstance<RenderBinding200>>,) => {
      ...
      {url: `/api/me/programs/${programId}/form-bindings/${bindingId}/render`, method: 'GET'
    },
      options);
    }
 ...
 * - 호출 방식: `GET /api/homepage/programs/{programId}/form-bindings/{bindingId}`
 *
 * ### 화면/프론트 사용 기준
...
const renderApplicationForm = (
 ...
 options?: SecondParameter<typeof customInstance<ApplicationFormResponse>>,) => {
      ...
      {url: `/api/homepage/programs/${programId}/form-bindings/${bindingId}`, method: 'GET',
        params
    },
      options);
    }
