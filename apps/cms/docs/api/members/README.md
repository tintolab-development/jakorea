...
| [**member-list-roles-query-redesign-overview-2026-08-07.md**](./member-list-roles-query-redesign-overview-2026-08-07.md) | **회원 목록 재설계 — 사람용 요약** (왜/화면/역할/필터 · 슬랙·미팅용) |
| [**member-list-roles-query-redesign-handoff-2026-08-07.md**](./member-list-roles-query-redesign-handoff-2026-08-07.md) | **회원 목록 재설계 (BE 계약)** — exact set · API 분기 · 페이지별 필터 · 체크리스트 |
| [**instructor-register-ui-openapi-mismatch-2026-08-06.md**](./instructor-register-ui-openapi-mismatch-2026-08-06.md) | **강사 등록 UI ↔ OpenAPI 불일치** (학력 상세·경력 rows·약관·미전송 필드) |
| [instructor-pre-register-detail-roundtrip-handoff-2026-08-06.md](./instructor-pre-register-detail-roundtrip-handoff-2026-08-06.md) | **강사 사전등록 ↔ 상세** · **§3.8 CMS 화면 기준 구조체** · 소속·마스킹 · FE profile 연동 |
