...
| [admin-pre-register-temp-password-handover-2026-07-28.md](./admin-pre-register-temp-password-handover-2026-07-28.md) | **관리자 사전등록** — 개인·강사 `rawPassword` 수용 (계정 아이디 = 임시 비밀번호) |
