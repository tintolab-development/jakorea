...
|--------------|--------------|---------|-----------|--------:|
| `registration-economy` | 1사 1교 프로그램 등록 폼 | A | [registration-economy.json](./form-template-seeds/registration-economy.json) | 5 |
...
| templateCode | templateName | Payload | 시드 JSON | 단락 수 |
|--------------|--------------|---------|-----------|--------:|
| `recruitment-participant-school` | 프로그램 참여자 모집 폼 (학교) | A | [recruitment-participant-school.json](./form-template-seeds/recruitment-participant-school.json) | 2 |
| `recruitment-participant-individual` | 프로그램 참여자 모집 폼 (개인) | A | [recruitment-participant-individual.json](./form-template-seeds/recruitment-participant-individual.json) | 2 |
| `recruitment-instructor` | 프로그램 강사 모집 폼 | A | [recruitment-instructor.json](./form-template-seeds/recruitment-instructor.json) | 2 |
| `recruitment-volunteer` | 프로그램 봉사자 모집 폼 | A | [recruitment-volunteer.json](./form-template-seeds/recruitment-volunteer.json) | 3 |
| `recruitment-ujat-school` | UJAT 프로그램 학교 모집 폼 | C | [recruitment-ujat-school.json](./form-template-seeds/recruitment-ujat-school.json) | 2 |
| `recruitment-ujat-volunteer` | UJAT 프로그램 봉사자 모집 폼 | C | [recruitment-ujat-volunteer.json](./form-template-seeds/recruitment-ujat-volunteer.json) | 3 |

### 신청 양식 (10)

| templateCode | templateName | Payload | 시드 JSON | 단락 수 |
|--------------|--------------|---------|-----------|--------:|
| `application-participant-school` | 프로그램 참여자 신청 폼 (학교) | A | [application-participant-school.json](./form-template-seeds/application-participant-school.json) | 7 |
| `application-participant-individual` | 프로그램 참여자 신청 폼 (개인) | A | [application-participant-individual.json](./form-template-seeds/application-participant-individual.json) | 5 |
| `application-instructor` | 프로그램 강사 신청 폼 | A | [application-instructor.json](./form-template-seeds/application-instructor.json) | 4 |
| `application-volunteer` | 프로그램 봉사자 신청 폼 | A | [application-volunteer.json](./form-template-seeds/application-volunteer.json) | 6 |
| `application-economy` | 1사1교 프로그램 참여자 신청 폼 | A | [application-economy.json](./form-template-seeds/application-economy.json) | 9 |
| `application-trained-teachers` | 교육받은 교사 프로그램 참여자 신청 폼 | A | [application-trained-teachers.json](./form-template-seeds/application-trained-teachers.json) | 4 |
| `application-gemini-visiting-training-instructor` | Gemini 찾아가는 연수 강사 신청 폼 | A | [application-gemini-visiting-training-instructor.json](./form-template-seeds/application-gemini-visiting-training-instructor.json) | 2 |
| `application-gemini-visiting-training-school` | Gemini 찾아가는 연수 참여 기관 신청 폼 | A | [application-gemini-visiting-training-school.json](./form-template-seeds/application-gemini-visiting-training-school.json) | 6 |
| `application-ujat-school` | UJAT 프로그램 학교 신청 폼 | C | [application-ujat-school.json](./form-template-seeds/application-ujat-school.json) | 8 |
| `application-ujat-volunteer` | UJAT 프로그램 봉사자 신청 폼 | C | [application-ujat-volunteer.json](./form-template-seeds/application-ujat-volunteer.json) | 9 |
...
| `survey-admin` | 강의 평가 (관리자용) | A | [survey-admin.json](./form-template-seeds/survey-admin.json) | 7 |
...
| `agreement-portrait` | 초상권 수집·이용 동의서 | A | [agreement-portrait.json](./form-template-seeds/agreement-portrait.json) | 8 |

## 단락 id 요약

### `registration-economy` — 1사 1교 프로그램 등록 폼
...
### `recruitment-participant-school` — 프로그램 참여자 모집 폼 (학교)
...
### `recruitment-participant-individual` — 프로그램 참여자 모집 폼 (개인)
...
### `recruitment-instructor` — 프로그램 강사 모집 폼
...
### `recruitment-volunteer` — 프로그램 봉사자 모집 폼
...
### `recruitment-ujat-school` — UJAT 프로그램 학교 모집 폼
...
### `recruitment-ujat-volunteer` — UJAT 프로그램 봉사자 모집 폼
...
### `application-participant-school` — 프로그램 참여자 신청 폼 (학교)
...
### `application-participant-individual` — 프로그램 참여자 신청 폼 (개인)
...
### `application-instructor` — 프로그램 강사 신청 폼
...
### `application-volunteer` — 프로그램 봉사자 신청 폼
...
### `application-economy` — 1사1교 프로그램 참여자 신청 폼
...
### `application-trained-teachers` — 교육받은 교사 프로그램 참여자 신청 폼
...
### `application-gemini-visiting-training-instructor` — Gemini 찾아가는 연수 강사 신청 폼
...
### `application-gemini-visiting-training-school` — Gemini 찾아가는 연수 참여 기관 신청 폼
...
### `application-ujat-school` — UJAT 프로그램 학교 신청 폼
...
### `application-ujat-volunteer` — UJAT 프로그램 봉사자 신청 폼
...
### `agreement-portrait` — 초상권 수집·이용 동의서
