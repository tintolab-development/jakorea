...
const base = (env.VITE_API_SERVER ?? 'https://12aa-221-146-247-18.ngrok-free.app').replace(/\/+$/, '')
...
console.log(`Wrote ${outputPath} (${statSync(outputPath).size} bytes, ${Object.keys(spec.paths).length} paths)`)
