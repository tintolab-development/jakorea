/**
 * 도메인별 색상 상수
 * CSS 토큰 SSOT: `apps/admin/src/app/providers/theme-provider.css` (:root)
 * CMS(`apps/cms`)와 동일 값 — 홈페이지 어드민 전용 미러.
...
export const uiColors = {
  ...
  moreButtonHover: 'var(--color-ui-more-button-hover)', // #3D3D3D
} as const

// UI 컴포넌트 색상 (Hex 값 - 인라인 스타일용)
export const uiColorsHex = {
  moreButton: '#3d3d3d',
  moreButtonHover: '#3d3d3d',
} as const
