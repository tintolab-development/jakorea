  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '재능기부',
        children: [
          { key: '/sponsor/talent/intro', label: '재능기부 소개 관리' },
          { key: '/sponsor/talent/applications', label: '재능기부 신청 관리' },
        ],
      },
    ],
  },
...
const PAGE_TITLE_BY_PATH: Record<string, string> = {
  ...
  '/main/popups': '팝업 관리',
  '/main/social-links': '메인 소셜 링크 관리',
  '/main/contents': '메인 콘텐츠 관리',
  ...
  '/sponsor/talent/intro': '재능기부 소개 관리',
  '/sponsor/talent/applications': '재능기부 신청 관리',
  '/participate': '참여하기 관리',
  '/site/info': '사이트 정보 관리',
  '/site/gnb': 'GNB 메뉴 관리',
  '/site/footer': '푸터 관리',
