...
const MODAL_DESCRIPTION = '재능기부의 상단 배너 이미지와 문구를 설정해 주세요.'
...
function BannerFormBody({ initial, confirmLoading, onCancel, onSubmit }: FormBodyProps) {
  ...
  return (
    <ContentModal
      ...
      width={800}
      className="talent-intro-banner-modal"
      footer={
        <>
          <CmsButton
            variant="secondary"
    ...
    >
      <DetailInfoForm
        ...
        hideHeader
        mode="edit"
        className="talent-intro-banner-modal__form"
      >
        <DetailInfoForm.Row type="single">
          <DetailInfoForm.Field
            ...
            edit={
              <div>
                <div className="talent-intro-banner-modal__image-row">
                  <div className="talent-intro-banner-modal__preview">
                    {imageUrl ? (
                  ...
                  <FileSelectField
                    className="talent-intro-banner-modal__file-field"
                    multiple={false}
                    accept={IMAGE_ACCEPT}
                    buttonLabel="파일 추가"
                ...
                {errors.image ? (
                  <p className="talent-intro-banner-modal__field-error" role="alert">
                    {errors.image}
                  </p>
                ) : null}
              </div>
