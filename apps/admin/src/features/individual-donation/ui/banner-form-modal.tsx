...
const MODAL_DESCRIPTION = '개인후원의 상단 배너 이미지와 문구를 설정해 주세요.'
...
type FormBodyProps = {
  initial: IndividualDonationBanner
...
function BannerFormBody({ initial, confirmLoading, onCancel, onSubmit }: FormBodyProps) {
  ...
  return (
    <ContentModal
      ...
      width={800}
      className="individual-donation-banner-modal"
      footer={
        <>
          <CmsButton
            variant="secondary"
    ...
    >
      <DetailInfoForm
        ...
        hideHeader
        mode="edit"
        className="individual-donation-banner-modal__form"
      >
        <DetailInfoForm.Row type="single">
          <DetailInfoForm.Field
            ...
            edit={
              <div>
                <div className="individual-donation-banner-modal__image-row">
                  <div className="individual-donation-banner-modal__preview">
                    {imageUrl ? (
                  ...
                  <FileSelectField
                    className="individual-donation-banner-modal__file-field"
                    multiple={false}
                    accept={IMAGE_ACCEPT}
                    buttonLabel="파일 추가"
                ...
                {errors.image ? (
                  <p className="individual-donation-banner-modal__field-error" role="alert">
                    {errors.image}
                  </p>
                ) : null}
              </div>
