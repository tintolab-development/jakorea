...
const schoolNameTemplates = [
  { prefix: ['서울', '부산', '대구', '인천', '광주', '대전', '울산'], suffix: ['초등학교', '중학교', '고등학교'] },
  { prefix: ['한국', '대한', '서울', '부산', '경기'], suffix: ['국제', '예술', '과학', '외국어', '체육'] },
  { prefix: ['중앙', '동부', '서부', '남부', '북부'], suffix: ['초등학교', '중학교', '고등학교'] },
  { prefix: ['청담', '반포', '잠실', '송파', '강남', '마포', '용산'], suffix: ['초등학교', '중학교', '고등학교'] },
]

// 담당자 이름 생성
const names = [
  '김민수', '이영희', '박지훈', '최수진', '정호영', '강미영', '조성민',
  '윤서연', '임동욱', '한지은', '오현우', '신유진', '배성호', '류혜진',
  '문재현', '송미라', '유태준', '홍지혜', '전동혁', '황수빈', '강민준',
  '서지영', '노현석', '엄예지', '양준호', '진소영', '차민규', '구나은',
]
...
function generatePhone(): string {
  const areaCodes = ['02', '031', '032', '041', '042', '043', '044', '051', '052', '053', '054', '055', '061', '062', '063', '064']
...
function generateAddress(region: string): string {
  ...
  const cityList = cities[region as keyof typeof cities] || [region]
...
// Mock 데이터 생성
const mockSchools: School[] = Array.from({ length: 30 }, () => {
...
// 빠른 조회를 위한 Map
export const mockSchoolsMap = new Map<string, School>()
